...
void main() {
  ...
  /// A suite of tests to ensure that the SignUpForm works as intended.
  group('SignUpForm', (){
    ...
    /// A suite of tests to ensure that certain methods are invoked when
    /// a value changes
    group('calls', () {

      /// test that emailChanged() is called when the email value changes
      ...
      /// test that passwordChanged() is called when the password value changes
      ...
      /// test that confirmedPasswordChanged() is called when the confirmedPassword changes
      ...
      /// test that the signUpFormSubmitted method is called when the sign up button is pressed
    ...
    /// A suite of tests to ensure that widgets are rendered in response
    /// to certain events
    group('renders', () {
      /// test that a SnackBar is generated when a FormzSubmissionStatus.failure
      /// state is emitted
      ...
      /// test that an invalid email error Text is generated
      ...
      /// test that an invalid password error text is generated when an invalid password is entered
      ...
      /// test that an invalid confirmedPassword error text is generated when an
      /// invalid confirmedPassword value is entered
      testWidgets(
      ...
      /// test that the sign Up Button is disabled when
      /// the SignUp Form is invalid
      ...
      // test that the sign Up Button is enabled when the SignUp Form is valid
   ...
   /// A suite of tests to ensure that the SignUpForm navigates between pages as intended
    group('navigates', () {
      /// test that SignUp Form navigates back to the Log In Page when the Form has been
      /// validated
